 ...
 * Date: 9/16/15
 * Time: 3:03 PM
 * purpose of the class is to describe name of Decrypted Ballot com.sergiuchuckmisha.bf.pages (this name is right under the top menu) in order to get rid of code duplication
